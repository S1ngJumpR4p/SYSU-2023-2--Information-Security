...
def DES_Encrypt(message, key):
    ...
    key_bits = key2bit_and_check(key)
...
def main():
    ...
    if choice == "1":
        ...
        bits = str2bit(message) # 转成0/1比特流
        print("Corresponding 0/1 bits: " + bits + "\n")
        encrypt_result = DES_Encrypt(bits, key)  # 使用DES加密
        print("Encrypted 0/1 bits: " + encrypt_result)
        output_file_name = input_file_name + "_encrypted.txt"
        ...
        bits = str2bit(message) # 转成0/1比特流
        print("Corresponding 0/1 bits: " + bits + "\n")
        decrypt_result = DES_Decrypt(bits, key)
        print("Decrypted 0/1 bits: " + encrypt_result)
